    ...
    <PageShell>
      <main className="min-h-screen bg-bg pt-28 text-ink">
        <section className="mx-auto max-w-4xl px-6 pb-24 md:px-8">
          ...
          <h1 className="mt-3.5 text-5xl font-black tracking-tight md:text-6xl">Contact Us</h1>
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-2">
            <div className="panel p-8">
              ...
              <p className="mt-4 font-mono text-ink-dim">{site.supportEmail}</p>
            </div>
            ...
            <div className="panel panel-alert p-8">
              ...
              <a
                ...
                className="mt-4 inline-block font-mono text-sm font-bold text-alert hover:underline"
              >
                Join Discord →
              </a>
            </div>
